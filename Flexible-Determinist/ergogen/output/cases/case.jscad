...
function mounting_extrude_4_outline_fn(){
    return CAG.circle({"center":[197.5823473,-177.5742688],"radius":2.5})
.union(
    CAG.circle({"center":[228.1357425,-130.4290201],"radius":2.5})
).union(
    CAG.circle({"center":[248.2211295,-86.7498652],"radius":2.5})
).union(
    CAG.circle({"center":[163.2308912,-104.1886879],"radius":2.5})
).union(
    CAG.circle({"center":[128.8794351,-177.5742688],"radius":2.5})
).union(
    CAG.circle({"center":[98.3260399,-130.4290201],"radius":2.5})
).union(
    CAG.circle({"center":[78.2406529,-86.7498652],"radius":2.5})
                ...
                function _mounting_case_fn() {
                    

                // creating part 0 of case _mounting
                let _mounting__part_0 = mounting_extrude_4_outline_fn();

                // make sure that rotations are relative
                let _mounting__part_0_bounds = _mounting__part_0.getBounds();
                let _mounting__part_0_x = _mounting__part_0_bounds[0].x + (_mounting__part_0_bounds[1].x - _mounting__part_0_bounds[0].x) / 2
                let _mounting__part_0_y = _mounting__part_0_bounds[0].y + (_mounting__part_0_bounds[1].y - _mounting__part_0_bounds[0].y) / 2
                _mounting__part_0 = translate([-_mounting__part_0_x, -_mounting__part_0_y, 0], _mounting__part_0);
                _mounting__part_0 = rotate([0,0,0], _mounting__part_0);
                _mounting__part_0 = translate([_mounting__part_0_x, _mounting__part_0_y, 0], _mounting__part_0);

                _mounting__part_0 = translate([0,0,0], _mounting__part_0);
                let result = _mounting__part_0;
                ...
                let case__part_1 = _mounting_case_fn();
